...
`.github/instructions/application-instructions/mkdocs.instructions.md`
...
- **Required**: ≥1 Mermaid diagram, 2–3 interview Q&A blocks, pre-reading links, abbreviations
  snippet
- Template:
