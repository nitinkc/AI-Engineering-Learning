...
Pre-reading: [04 Evals, Observability, and Production](../05-ai-engineer-playbook/04-evals-observability-production.md) · [07 Incremental Learning Labs](../05-ai-engineer-playbook/07-incremental-learning-labs.md)
...
```bash
cd docs/06-mini-projects/code/week03-eval-observability
