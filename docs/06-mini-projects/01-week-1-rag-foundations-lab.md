...
Pre-reading: [01 Learning Path](../05-ai-engineer-playbook/01-learning-path.md) · [02 RAG Debugging and Quality](../05-ai-engineer-playbook/02-rag-debugging-quality.md)
...
```bash
cd docs/06-mini-projects/code/week01-rag-foundations
