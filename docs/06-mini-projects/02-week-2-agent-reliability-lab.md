...
Pre-reading: [03 Agentic Workflows](../05-ai-engineer-playbook/03-agentic-workflows.md) · [07 Incremental Learning Labs](../05-ai-engineer-playbook/07-incremental-learning-labs.md)
...
```bash
cd docs/06-mini-projects/code/week02-agent-reliability
