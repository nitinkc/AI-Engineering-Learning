# 06 - Incremental Learning Labs (Memory-First)

> **Pre-reading:** [Daily Learning Plan](../02-learning-revision-plan/index.md) · [01 RAG Debugging and Quality](01-rag-debugging-quality.md) · [02 Agentic Workflows](02-agentic-workflows.md)
...
|---|---|---|
| Lab A | [01 RAG Debugging and Quality](01-rag-debugging-quality.md) | It gives you the failure taxonomy and debug order. |
| Lab B | [01 RAG Debugging and Quality](01-rag-debugging-quality.md) | It supplies the retrieval metrics and prototype flow. |
| Lab C | [02 Agentic Workflows](02-agentic-workflows.md) | It defines schemas, approvals, retries, and escalation. |
| Lab D | [03 Evals, Observability, Production](03-evals-observability-production.md) | It provides the release-gate and trace mindset. |
| Lab E | [04 STAR Story System](04-star-story-system.md) and [05 Interview Sprints and Mock Loops](05-interview-sprints-and-mock-loops.md) | They turn lab outputs into interview-ready stories. |
...
Next: [07 Daily Material Map](07-daily-material-map.md)
